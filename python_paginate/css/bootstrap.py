...
class BaseBootstrap(basecss.BaseCSS):
    ...
    def __init__(self, *args, **kwargs):
        super(BaseBootstrap, self).__init__(*args, **kwargs)
...
class Bootstrap2(BaseBootstrap):
    css_head_fmt = '<div class="pagination{size}{align}{extra}"><ul>'
    css_end_fmt = '</ul></div>'
    ...
    def __init__(self, *args, **kwargs):
        super(Bootstrap2, self).__init__(*args, **kwargs)


class Bootstrap3(BaseBootstrap):
    css_head_fmt = '<nav><ul class="pagination{size}{align}{extra}">'
    css_end_fmt = '</ul></nav>'
    ...
    def __init__(self, *args, **kwargs):
        super(Bootstrap3, self).__init__(*args, **kwargs)
...
class Bootstrap4(Bootstrap3):
    ...
    def __init__(self, *args, **kwargs):
        super(Bootstrap4, self).__init__(*args, **kwargs)
